                ...
                <div class="shadow bg-white overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <form wire:submit.prevent="update" class="p-2">
                        <div class="col-span-6 sm:col-span-3 mb-2">
                            ...
                            <select type="text" wire:model.defer="car.brand_id" id="brand" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6 sm:col-span-3 mb-2">
                            ...
                            <input type="text" wire:model.defer="car.model" id="model" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-3 mb-2">
                            <label for="vehicle_color" class="block text-sm font-medium text-gray-700">Cor do veículo</label>
                            <input type="text" wire:model.defer="car.color" id="vehicle_color" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
